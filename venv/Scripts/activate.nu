...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\johne\PycharmProjects\Django_form_creation_app\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\johne\PycharmProjects\Django_form_creation_app\venv\Scripts\deactivate.nu'
